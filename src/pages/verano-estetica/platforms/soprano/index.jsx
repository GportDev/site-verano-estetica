...
import { ButtonFilled, Container, ContentSection, Section, Subtitle, Text  } from "../../../../components/styles/styles";
import { ListLine, PlatSection, BenefitsList, Equipment, ThirdTitle, Video } from "./styles";
import SopranoIce from "../../../../assets/images/Platforms/soprano.png"
    ...
    <>
      ...
      <Container>
        ...
        <PlatSection className="content">
          ...
          <ButtonFilled>Agende agora sua sessão</ButtonFilled>
        </PlatSection>
        <Section>
          <Subtitle>Funcionamento do aparelho</Subtitle>
          <Video />
        </Section>
        <Contact />
        <Footer />
